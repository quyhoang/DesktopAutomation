...
def loopVideo():
    ...
    while run_flag and not terminate_thread.is_set(): # Check for termination signal
...
def main():
    ...
    table = PrettyTable()
    table.add_column("Shortcut", ["W", "E", "R", "T","Delete","]"]) 
    table.add_column("Repeater Function", ["Mark beginning", "Mark ending/ start looping", "Repeat 10 more times", "Exit loop", "Exit program", ""])
